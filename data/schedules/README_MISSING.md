...
**Расписание есть (JSON в `data/schedules/`):** все серии из конфига, в том числе `arca`, `dtm`, `elms`, `f1`, `f2`, `f3`, `f4_it`, `frec`, `gtwce_end`, `gtwce_sprint`, `imsa`, `indycar`, `nascar_cup`, `nascar_modified`, `nascar_truck`, `noaps`, `psc`, `supercars`, `super_formula`, `super_gt`, `wec`.
