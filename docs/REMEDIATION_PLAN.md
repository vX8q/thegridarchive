...
> **Статус:** исторический план рефакторинга фронтенда (фазы 3.x). Фазы 3.0–3.5 в коде уже сделаны (2026-08). Для текущей эксплуатации см. [`README.md`](../README.md), [`RUNBOOK.md`](RUNBOOK.md), [`RELEASE_CHECKLIST.md`](RELEASE_CHECKLIST.md). Не использовать как актуальный backlog без сверки с кодом.
>
