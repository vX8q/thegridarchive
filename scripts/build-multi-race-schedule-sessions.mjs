...
// ── SMP F4 Russia — 4 races per round (MSK) ──────────────────────────────────
const smpTemplate = (sat, sun) => [
  sess('Race 1', sat, '12:30'),
  sess('Race 2', sat, '16:00'),
  sess('Race 3', sun, '11:45'),
  sess('Race 4', sun, '15:10'),
];
sessions.SMP_F4_RU_2026_1 = smpTemplate('2026-05-16', '2026-05-17');
sessions.SMP_F4_RU_2026_2 = [
  sess('Race 1', '2026-06-13', '12:10'),
  sess('Race 2', '2026-06-13', '16:35'),
  sess('Race 3', '2026-06-14', '11:45'),
  sess('Race 4', '2026-06-14', '15:10'),
];
const smpSched = JSON.parse(fs.readFileSync(path.join(root, 'data/schedules/smp_f4_ru.json'), 'utf8'));
for (const e of smpSched) {
  const id = e.id.toUpperCase();
  if (!sessions[id]) sessions[id] = smpTemplate(e.start_date, e.end_date);
}
