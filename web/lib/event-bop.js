...
(function () {
  ...
  function renderBopContent(escapeFn, eventData) {
    ...
    var gtpCars = isImsa2026Round3 ? [
      ...
      ['Acura', 'ARX-06', '1045', '9512', '99.0', '100.0', '230', '240', '912', '22.800', 'R80'],
      ['Aston Martin', 'Valkyrie', '1020', '8400', '100.0', '100.0', '230', '240', '912', '22.800', 'R80'],
      ['BMW', 'M Hybrid V8', '1030', '8000', '100.0', '98.5', '230', '240', '906', '22.650', 'R80'],
      ['Cadillac', 'V-Series.R', '1053', '8800', '97.9', '99.6', '230', '240', '908', '22.700', 'R80'],
      ['Porsche', '963 (2026 Homologation)', '1066', '8158', '96.5', '99.2', '230', '240', '907', '22.675', 'R80'],
      ['Porsche', '963 (2025 Homologation)', '1062', '8158', '97.3', '99.0', '230', '240', '906', '22.650', 'R80']
    ] : [
    ...
    var gtpRegForRender = (isImsa2026Round4 || isImsa2026Round5 || isImsa2026Round6 || isImsa2026Round8)
    ...
    var gtdCars = isImsa2026Round3 ? [
      ...
      ['Aston Martin', 'Vantage GT3 EVO', '1292', '7000', '91.2', '86.8', '190', '200', '5.0', '11.1', '846', '21.150'],
      ['BMW', 'M4 GT3 EVO', '1341', '7500', '92.2', '92.1', '190', '200', '-2.0', '5.0', '855', '21.375'],
      ['Corvette', 'Z06 GT3.R', '1376', '8000', '97.2', '98.0', '190', '200', '-1.8', '6.4', '875', '21.875'],
      ['Ferrari', '296 GT3 EVO', '1355', '7750', '87.1', '86.9', '190', '200', '-1.7', '4.1', '850', '21.250'],
      ['Ford', 'Mustang GT3', '1332', '8250', '98.0', '97.1', '190', '200', '-0.4', '7.1', '882', '22.050'],
      ['Lamborghini', 'Huracan GT3 EVO2', '1325', '8300', '85.6', '89.1', '190', '200', '2.0', '8.4', '869', '21.725'],
      ['Lamborghini', 'Temerario GT3', '1337', '8000', '94.4', '88.1', '190', '200', '1.0', '6.8', '923', '23.075'],
      ['Lexus', 'RC F GT3', '1359', '7200', '92.3', '95.2', '190', '200', '4.0', '11.0', '913', '22.825'],
